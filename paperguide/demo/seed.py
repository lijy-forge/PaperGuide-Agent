...
def _demo_uuid(name: str) -> UUID:
    return uuid5(NAMESPACE_URL, f"https://paperguide.local/demo/{name}")
...
_PAPER_DATA = (
    ...
    },
    {
        ...
        "authors": ("PaperGuide Curated Demo Team",),
        "year": 2023,
        ...
        paper = PaperCandidate(
            ...
            authors=[
                Author(
                    ...
                    affiliations=["PaperGuide Demo Lab"],
                )
                for name in item["authors"]
            ],
            publication_year=int(item["year"]),
            venue="PaperGuide Offline Demo Proceedings",

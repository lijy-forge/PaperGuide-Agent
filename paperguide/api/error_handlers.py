...
from paperguide.application import TaskNotFoundError
from paperguide.execution import PersistentTaskStoreError
from paperguide.runtime.host import SchemaMigrationError, TaskHostUnavailableError

from .exceptions import APIError
from .schemas import ErrorResponse

LOGGER = logging.getLogger("paperguide.api")
...
async def _internal_error_handler(
    ...
    settings = request.app.state.paperguide_dependencies.settings
    LOGGER.error(
        "API request failed",
        extra={

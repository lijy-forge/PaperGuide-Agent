"""Non-secret, environment-backed settings for the PaperGuide runtime."""
...
class RuntimeSettings(BaseModel):
    ...
    export_directory: Path = Path("paperguide-exports")
    ...
    def from_env(
        ...
        """Load only whitelisted ``PAPERGUIDE_`` environment variables."""
    ...
    def to_bootstrap_config(self) -> BootstrapConfig:
        ...
        download_directory = export_directory.parent / "paperguide-downloads"
    ...
    def task_database_path(self) -> Path:
        ...
        return Path(self.export_directory).parent / "paperguide-runtime.sqlite3"

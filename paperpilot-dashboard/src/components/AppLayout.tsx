...
export function AppLayout() {
  ...
  return <Layout className="app-shell">
    <Sider breakpoint="lg" collapsedWidth="0" className="app-sider">
      <Link className="brand brand-side" to="/">PaperPilot <span>AI</span></Link>
    ...
    <Layout>
      <Header className="app-header">
        <div><Typography.Text className="eyebrow">技术调研中心</Typography.Text><Typography.Title level={4}>PaperPilot AI</Typography.Title></div>

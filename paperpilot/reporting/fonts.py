...
class CJKFontResolver:
    ...
    An explicit ``PAPERPILOT_CJK_FONT_PATH`` takes precedence. Windows uses
    ...
    def resolve(self) -> Path:
        ...
        raise CJKFontResolutionError(
            "No embeddable CJK font was found. Configure PAPERPILOT_CJK_FONT_PATH "
            "or install Noto Sans CJK."
        )

    @staticmethod
    def _environment_path() -> Path | None:
        value = os.getenv("PAPERPILOT_CJK_FONT_PATH", "").strip()

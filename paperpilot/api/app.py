...
from paperpilot.runtime.host import PersistentTaskHostClient, SQLiteHostBroker
from paperpilot.runtime.metrics import MetricsExporterProtocol
...
def create_api_app(
    *,
    ...
    if dependencies is None:
        ...
        if all(value is not None for value in explicit):
            settings = api_settings or APISettings(
                artifact_root=artifact_root or "paperpilot-exports",
            )
    ...
    app.state.paperpilot_dependencies = APIDependencies(

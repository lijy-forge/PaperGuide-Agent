"""One-shot, cost-bounded execution of the real PaperPilot application graph."""
...
from paperpilot.bootstrap import BootstrapConfig, create_application
from paperpilot.domain import PaperSource
from paperpilot.orchestration import ResearchState
from paperpilot.orchestration.graph_factory import create_research_graph
...
class SmokeTestRunner:
    ...
    def _validate_output_directory(directory: Path) -> None:
        ...
        descriptor, name = tempfile.mkstemp(prefix=".paperpilot-smoke-", dir=directory)
        os.close(descriptor)
        Path(name).unlink()

  ...
  return (
    <div className="page-stack">
      <section className="hero-panel">
        <div>
          <Typography.Text className="eyebrow">PAPERGUIDE AI</Typography.Text>
          <Typography.Title>PaperGuide AI</Typography.Title>
      ...
      {runtimeHealth.state === "host_offline" && (
        <Alert
          ...
          showIcon
          message="任务主机不可用"
          description={<>请运行以下命令启动：<Typography.Text code>paperguide server start</Typography.Text></>}
        />
      )}
      ...
      {runtimeHealth.state === "api_offline" && (
        <Alert
          ...
          showIcon
          message="API 离线"
          description="无法连接 PaperGuide API。"
        />
      )}
